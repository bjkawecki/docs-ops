...
export type ContextScopePageModalsProps = {
  scope: NewContextScope;
  /** Nur Personal: Draft ohne Kontext erlauben. */
  documentModalAllowNoContext?: boolean;
...
export function ContextScopePageModals({
  scope,
  ...
  return (
    <>
      ...
      <NewDocumentModal
        ...
        scope={scope}
        onSuccess={onInvalidateContexts}
        allowNoContext={documentModalAllowNoContext}
      />
