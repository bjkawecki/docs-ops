...
export function ReviewsPage() {
  ...
  return (
    <Box>
      <PageHeader
        title="Reviews"
        description="Open draft requests on documents you can merge or reject (scope lead / admin)."
      />
      <Stack gap="md">
        {isPending ? (
          <Group>
          ...
          <Alert color="red" title="Could not load reviews">
            Failed to load pending reviews. Try again later.
          </Alert>
