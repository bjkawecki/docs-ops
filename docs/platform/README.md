...
| **adr/**            | [Architecture Decision Records](adr/README.md) – festgehaltene Architekturentscheidungen (z. B. Edit-System Blocks/Suggestions).                                                                |
...
4. **adr/** – Architekturentscheidungen (z. B. Edit-System Blocks/Suggestions).
5. **ui-architektur/** – Dashboard (URLs) und Architektur/Workflow.
