...
- Umsetzungsstand: [Umsetzungs-Todo §14](Umsetzungs-Todo.md#14-dokumente-in-der-ui) (Tag-Verwaltung, Markdown-Editor, Rechte-Checks, CRUD in Kontexten umgesetzt; Drafts-Card im Overview, Drafts-Tab siehe dort; Produkthilfe über **Help** `/help/…`).
